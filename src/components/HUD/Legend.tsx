    ...
    <div className="bg-slate-900/85 backdrop-blur-md border border-slate-800/90 p-3 rounded-2xl shadow-xl flex flex-col gap-2 text-xs">
      ...
      <div className="flex flex-col gap-1.5 text-[11px]">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-300 font-semibold text-cyan-400">Water & Storm Runoff</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded bg-[#FFB300]" />
          <span className="text-slate-300">Building Warning (0.15m - 0.40m)</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded bg-[#FF1744] shadow-[0_0_8px_rgba(255,23,68,0.8)]" />
          <span className="text-slate-300 font-semibold text-red-400">Building Critical Threat (&ge; 0.40m)</span>
        </div>
